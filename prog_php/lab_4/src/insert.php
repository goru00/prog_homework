<?php
    ...
    if (isset($_POST['country']) && isset($_POST['num_player']) && isset($_POST['amp']) && isset($_POST['name_player']))
    {
        ...
        $query = "INSERT INTO `Игроки` VALUES ('$num_player', '$name_player', '$country', '$amp');";
